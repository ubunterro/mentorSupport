...
<body style="background-color: #a5cf9a;">
    ...
    <div class="search"><a name="search"></a>
        ...
        <div id='searche' name='searche' class='formsearch'>
...
<script  src="js/jsty.js" type="text/javascript"></script>
...
$.ajax({
  url: "job/gethacks.php",
  type:'GET',
  success: function(data) {
    var hacks = JSON.parse(data);


    for(var i = 0; i < hacks.length; i++)
    {
        var opt = new Option(hacks[i][0], hacks[i][1]);
        $(".textinput").append(opt);
    }
...
$(document.body).on("select2:select", ".textinput", function(e) {
    window.location.href = $(".textinput").val();
});
